...
Source0  : https://files.pythonhosted.org/packages/96/8e/709914eb2b5749865801041647dc7f4e6d00b549cfe88b65ca192995f07c/distlib-0.4.0.tar.gz
...
%prep
%setup -q -n distlib-0.4.0
cd %{_builddir}/distlib-0.4.0
pushd ..
cp -a distlib-0.4.0 buildavx2
popd
pushd ..
cp -a distlib-0.4.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752795820
...
rm -f %{buildroot}*/usr/lib/python3.13/site-packages/distlib/t32.exe
rm -f %{buildroot}*/usr/lib/python3.13/site-packages/distlib/t64-arm.exe
rm -f %{buildroot}*/usr/lib/python3.13/site-packages/distlib/t64.exe
rm -f %{buildroot}*/usr/lib/python3.13/site-packages/distlib/w32.exe
rm -f %{buildroot}*/usr/lib/python3.13/site-packages/distlib/w64-arm.exe
rm -f %{buildroot}*/usr/lib/python3.13/site-packages/distlib/w64.exe
